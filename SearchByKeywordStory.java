...
public class SearchByKeywordStory {
    ...
    @Test
    public void searching_by_keyword_ginger_should_display_the_corresponding_article() {
        anna.is_the_home_page();
        anna.looks_for("ginger");
        anna.should_see_definition("The pungent aromatic rhizome of a tropical Asian herb, Zingiber officinale, used as a spice and as a stimulant and acarminative.");
    }
